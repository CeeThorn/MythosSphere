  ...
  galaxies: [
    {
      ...
      media: [
        { id: "batman-the-animated-series-dcau", source_id: null, name: "Batman: The Animated Series" },
        { id: "batman-mask-of-the-phantasm-dcau", source_id: null, name: "Batman: Mask of the Phantasm" },
        { id: "the-new-batman-adventures-dcau", source_id: null, name: "The New Batman Adventures" },
        { id: "batman-and-mr-freeze-subzero-dcau", source_id: null, name: "Batman & Mr. Freeze: SubZero" },
        { id: "superman-the-animated-series-dcau", source_id: null, name: "Superman: The Animated Series" },
        { id: "superman-brainiac-attacks-dcau", source_id: null, name: "Superman: Brainiac Attacks", timeline_note: "This movie is not considered canon to the DCAU by the creators, but is included as requested." },
        { id: "gotham-girls-dcau", source_id: null, name: "Gotham Girls" },
        { id: "lobo-webseries-dcau", source_id: null, name: "Lobo (Webseries)", timeline_note: "This webseries is not officially considered part of the DCAU but was created by some of the same team and is often associated with it." },
        { id: "static-shock-dcau", source_id: null, name: "Static Shock", timeline_note: "The episodes 'The Big Leagues', 'Hard as Nails', and 'A League of Their Own' Parts 1 & 2 feature crossovers with the Justice League and occur during the 'Justice League' series timeline. 'Future Shock' is a crossover with 'Batman Beyond' and takes place during that show's timeline." },
        { id: "justice-league-dcau", source_id: null, name: "Justice League" },
        { id: "justice-league-unlimited-dcau", source_id: null, name: "Justice League Unlimited", timeline_note: "The episode 'Epilogue' should be watched after 'Batman Beyond' and 'Batman Beyond: Return of the Joker'." },
        { id: "batman-mystery-of-the-batwoman-dcau", source_id: null, name: "Batman: Mystery of the Batwoman" },
        { id: "batman-and-harley-quinn-dcau", source_id: null, name: "Batman and Harley Quinn", timeline_note: "The canonicity of this film is debatable. While executive producer Bruce Timm considers it canon, it is often seen as a standalone story." },
        { id: "justice-league-vs-the-fatal-five-dcau", source_id: null, name: "Justice League vs. The Fatal Five", timeline_note: "Similar to 'Batman and Harley Quinn', the canonicity of this film is open to interpretation. Executive producer Bruce Timm regards it as canon." },
        { id: "batman-beyond-dcau", source_id: null, name: "Batman Beyond" },
        { id: "the-zeta-project-dcau", source_id: null, name: "The Zeta Project", timeline_note: "This series is a spin-off of 'Batman Beyond'." },
        { id: "batman-beyond-return-of-the-joker-dcau", source_id: null, name: "Batman Beyond: Return of the Joker" },
      ],
      relationships: [
        {
          toId: "caped-crusader",
    ...
    },
    {
      ...
      media: [
        { id: "the-flashpoint-paradox-dcamu", source_id: null, name: "Justice League: The Flashpoint Paradox" },
        { id: "justice-league-war-dcamu", source_id: null, name: "Justice League: War" },
        { id: "son-of-batman-dcamu", source_id: null, name: "Son of Batman" },
        { id: "justice-league-throne-of-atlantis-dcamu", source_id: null, name: "Justice League: Throne of Atlantis" },
        { id: "batman-vs-robin-dcamu", source_id: null, name: "Batman vs. Robin" },
        { id: "batman-bad-blood-dcamu", source_id: null, name: "Batman: Bad Blood" },
        { id: "justice-league-vs-teen-titans-dcamu", source_id: null, name: "Justice League vs. Teen Titans" },
        { id: "justice-league-dark-dcamu", source_id: null, name: "Justice League Dark" },
        { id: "teen-titans-the-judas-contract-dcamu", source_id: null, name: "Teen Titans: The Judas Contract" },
        { id: "suicide-squad-hell-to-pay-dcamu", source_id: null, name: "Suicide Squad: Hell to Pay" },
        { id: "death-and-return-of-superman-dcamu", source_id: null, name: "The Death and Return of Superman", timeline_note: "This represents the two-part story told in 'The Death of Superman' and 'Reign of the Supermen'." },
        { id: "constantine-city-of-demons-dcamu", source_id: null, name: "Constantine: City of Demons", timeline_note: "This movie's events occur concurrently with the 'Death of Superman' storyline." },
        { id: "wonder-woman-bloodlines-dcamu", source_id: null, name: "Wonder Woman: Bloodlines", timeline_note: "While released later, the majority of this film consists of flashbacks that take place before 'Justice League: War', with the present-day scenes happening after 'Reign of the Supermen'." },
        { id: "batman-hush-dcamu", source_id: null, name: "Batman: Hush" },
        { id: "justice-league-dark-apokolips-war-dcamu", source_id: null, name: "Justice League Dark: Apokolips War" },
        { id: "constantine-the-house-of-mystery-dcamu", source_id: null, name: "Constantine: The House of Mystery", timeline_note: "This film serves as an epilogue to the DCAMU, directly following the events of 'Apokolips War'." }
      ],
      relationships: [
        {
          toId: "tomorrowverse",
    ...
    },
    {
      ...
      watch_type: ["movies"],
      media: [
        { id: "superman-man-of-tomorrow-tomorrowverse", source_id: null, name: "Superman: Man of Tomorrow" },
        { id: "justice-society-wwii-tomorrowverse", source_id: null, name: "Justice Society: World War II", timeline_note: "The framing story with The Flash takes place in the present day, but the main plot is set in the past." },
        { id: "batman-the-long-halloween-tomorrowverse", source_id: null, name: "Batman: The Long Halloween", timeline_note: "This story is told across two parts." },
        { id: "green-lantern-beware-my-power-tomorrowverse", source_id: null, name: "Green Lantern: Beware My Power" },
        { id: "legion-of-super-heroes-tomorrowverse", source_id: null, name: "Legion of Super-Heroes" },
        { id: "justice-league-warworld-tomorrowverse", source_id: null, name: "Justice League: Warworld" },
        { id: "justice-league-crisis-on-infinite-earths-tomorrowverse", source_id: null, name: "Justice League: Crisis on Infinite Earths", timeline_note: "This is a three-part finale to the Tomorrowverse." }
      ],
      relationships: [
        {
          toId: "dcamu",
